...
void SrNormalCasterStage::Init()
{
}

void SrNormalCasterStage::PreDraw()
{
	SpDirectX* dx = GetSpDX();
	dx->cmdList->SetPipelineState(GPipeline::GetState("NormalCaster"));
	dx->cmdList->SetGraphicsRootSignature(SpRootSignature::Get("NormalCaster")->rootsignature.Get());
	...
	RTVManager::SetRenderTargetToTexture("NormalMap");
}

void SrNormalCasterStage::PostDraw()
{
}

void SrNormalCasterStage::Render()
{
...
void SrNormalCasterStage::DrawCommands(std::function<void(void)> cmd, TextureKey rt)
{
