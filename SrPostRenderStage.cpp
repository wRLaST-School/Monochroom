...
void SrPostRenderStage::Init()
{
}

void SrPostRenderStage::PreDraw()
{
...
void SrPostRenderStage::PostDraw()
{
}

void SrPostRenderStage::Render()
{
...
void SrPostRenderStage::DrawCommands(std::function<void(void)> cmd, TextureKey rt)
{
